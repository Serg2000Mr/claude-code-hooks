...
<details>
<summary><b>1. Звук при запросе разрешения</b></summary>
...
**Звуковой файл:** `C:/Windows/Media/Windows Unlock.wav`
Проверьте его наличие. Если файл отсутствует, скачайте его из папки [sounds/](sounds/) этого репозитория и положите в любое удобное место, указав путь в команде хука.
...
<details>
<summary><b>2. Защита файлов вне диска C:</b></summary>
